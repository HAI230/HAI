...
const Contact = () => {
  return <div className='h-full bg-primary/30'>
    <div className="container mx-auto py-32 text-center xl:text-left flex item-center justify-center h-full">
    {/* text & form*/}    
    <div className='flex flex-col w-full max-w-[700px]'>
      ...
      {/* Group */}
        ...
        <button className='btn rounded-full border broder-white/50 max-w-[170px]

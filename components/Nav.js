...
import { useRouter } from 'next/router'; // Import the useRouter hook correctly
...
const Nav = () => {
  ...
  return (
    ...
    xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md xl:h-screen'>
      ...
      gap-y-10 px-4 md:px-40 xl:px-0 h-[75px] xl:h-max py-8 bg-white/10 backdrop-blur-sm text-3xl xl:text-xl xl:rounded-full'>
          ...
          >
            ...
            <div className='absolute pr-14 right-0 hidden xl:group-hover:flex'>
              <div className='bg-white relative flex text-primary items-center p-[6px] rounded-sm-[3px]'>
                ...
                {/* triangle */}
                <div className='border-solid border-l-white border-l-8 border-y-transparent border-y-[8px]
